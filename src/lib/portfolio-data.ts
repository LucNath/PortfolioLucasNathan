...
export const featuredProjects = [
  ...
  {
    tag: "IoT",
    title: "Staff Telemetria Geofence",
    description:
      "Sistema de telemetria com geofencing para rastreamento de pessoal, integrando IoT, geolocalização e processamento de dados em tempo real.",
    stack: ["Python", "IoT", "Geolocalização", "Telemetria"],
  },
];
...
export const additionalProjects = {
  "Frontend & Web": [
    ...
    "Nuvem Joguinho (Jogo Web)",
  ],
  "Acadêmicos & Estudos": [
    "Beecrowd Solutions (Algoritmos)",
    "Classificação e Regressão (ML)",
    "Android Mobile — Desenvolvimento Avançado",
    "Sistemas Embarcados (8051, STM32)",
  ],
};

export const education = {
  course: "Engenharia de Computação — UNIFOR (Universidade de Fortaleza)",
  status: "Em andamento",
  subjects: [
